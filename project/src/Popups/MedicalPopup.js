...
function MedicalPopup({ closePopup, theKey, showDonateOptions, setShowDonateOptions, handleDonate }) {
        ...
        <div className="footer">
          {showDonateOptions === matchedItem.id ? (
            <>
              ...
              <button onClick={() => navigate('/DonationSuccessful')} style={{ margin: '10px' }}>
                No thank you
              </button>
            ...
            <>
             <button onClick={() => closePopup()} style={{ margin: '10px' }}>
              ...
              <button onClick={() => setShowDonateOptions(matchedItem.id)} style={{ margin: '10px' }}>
                Donate
              </button>
