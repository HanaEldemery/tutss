...
function TeacherPopup({ closePopup, theKey, showDonateOptions, setShowDonateOptions, handleDonate }) {
          ...
          {showDonateOptions === teacher.id ? (
            ...
            <>
             <button onClick={() => closePopup()} style={{ margin: '10px' }}>
              ...
              <button onClick={() => setShowDonateOptions(teacher.id)} style={{ margin: '10px' }}>
                Donate
              </button>
