...
function OrgReg() {
  // my first name, last name, gender, email, password, contact number, organization name, organization type, and organization address, area, governorate,
        ...
        <form onSubmit={handleSubmit} className="form">
          <div className="input-container">
            ...
            <div className="input-wrapper">
              ...
              <h2>Please Upload an Official Government License  to Ensure Authentication of Organization</h2>
          ...
          <button type="submit" className="donation-button">Register</button>
        </form>
      </div>
    </div>
  );
