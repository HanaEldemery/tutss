...
function DropoffSelection() {
    ...
    const timeSlots = ['9:00 AM - 11:00 AM', '10:00 AM - 12:00 PM', '11:00 AM - 1:00 PM', '1:00 PM - 3:00 PM', '2:00 PM - 4:00 PM', '3:00 PM - 5:00 PM'];
            ...
            {showConfirmation && (
                <div className="confirm">
                    <div className="confirm_message">
                        <p>Drop Off Slot Confirmed, We will get in touch when the donation is about to arrive</p>
                        <Link to="/Donor"> {/*al 3amel organization yeghayarha lel howa 3ayzo*/}
